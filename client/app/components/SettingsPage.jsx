...
const mapDispatchToProps = data => dispatch => ({
  startUpdateGeneral: data => dispatch(startUpdateGeneral(data)),
  startUpdatePassword: data => dispatch(startUpdatePassword(data)),
  startUpdateTransfer: data => dispatch(startUpdateTransfer(data))
})
